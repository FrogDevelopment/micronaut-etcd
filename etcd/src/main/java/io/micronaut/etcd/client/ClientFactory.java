...
public class ClientFactory {
    ...
    private Client getClient(EtcdFactoryConfig config) {
        ...
        clientBuilder.keepaliveTime(config.getKeepaliveTime());
        clientBuilder.keepaliveTimeout(config.getKeepaliveTimeout());
